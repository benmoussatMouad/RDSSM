...
class SsmMessage(metaclass=Metaclass_SsmMessage):
    ...
    def __init__(self, **kwargs):
        ...
        self.dssm_msg_len = kwargs.get('dssm_msg_len', int())
    ...
    def __eq__(self, other):
        ...
        if self.save_time != other.save_time:
            return False
        if self.dssm_msg_len != other.dssm_msg_len:
            return False
        return True
    ...
    @builtins.property
    def dssm_msg_len(self):
        """Message field 'dssm_msg_len'."""
        return self._dssm_msg_len

    @dssm_msg_len.setter
    def dssm_msg_len(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'dssm_msg_len' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'dssm_msg_len' field must be an integer in [-2147483648, 2147483647]"
        self._dssm_msg_len = value
